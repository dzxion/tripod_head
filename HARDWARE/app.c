...
vector3 target_angular_rate = {0.0f,0.0f,0.0f};//目标陀螺角速度（deg/s）
...
/****************************************************************************************
*原  型：void ctrl_angular_velocity(vector3 target_angular_rate,vector3 current_angular_rate)
*功  能：角速度控制
*输  入：target_angular_rate :目标角速度
*输  入：current_angular_rate :当前四元数
*输  出：无
*****************************************************************************************/
...
/****************************************************************************************
*原  型：void ctrl_Attitude_Q(vector3* u, Quaternion target_quat, Quaternion current_quat)
*功  能：姿态控制
*输  入：*u :姿态控制器输出
*输  入：target_quat :目标四元数
*输  入：current_quat：当前四元数
*输  出：无
*****************************************************************************************/
...
/****************************************************************************************
*原  型：void ctrl_Attitude_decoup(vector3* u, Quaternion target_quat, Quaternion current_quat)
*功  能：姿态控制（姿态解耦）
*输  入：*u :姿态控制器输出
*输  入：target_quat :目标四元数
*输  入：current_quat：当前四元数
